...
datasets = ['Real_J', 'Real_R']

for dataset in datasets:

    file_path = os.path.join('/home/yoga/save_pth/xgl2/fuse_lmff_aia_bigmodel_wres/log/UNet_small_baseline/results/epoch_2750', dataset)
    gt_path = os.path.join('/home/yoga/save_pth/', dataset, 'test', 'sharp')
